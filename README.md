...
|       baseUrls()                                 |           NULL                |        Comma separated BaseURLs for the MPD: <url>[,<url>]….
...
|       utcTimings()                               |           NULL                |          Comma separated UTCTiming schemeIdUri and value pairs for the MPD: <scheme_id_uri>=<value>[,<scheme_id_uri>=<value>]…
